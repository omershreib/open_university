...
from introduction_to_AI.models import Problem, Node, make_node, to_vector
from tiles_game_state import TilesGameState
from tiles_board import TilesBoard
import numpy as np
...
tiles_actions_descriptions = {str(UP): 'UP', str(DOWN): 'DOWN', str(LEFT): 'LEFT', str(RIGHT): 'RIGTH'}
...
class TilesGameProblem(Problem):
    def __init__(self, initial_state: TilesGameState, transition_model=None, action_cost=None):
        super().__init__()
