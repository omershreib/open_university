...
3. אני מודע לכך שבעיקרון קובץ ה README צריך להיות PDF, אולם לא משנה מה עשיתי, כל פעם שניסיתי להמיר את הקובץ הזה לפורמט PDF משהו השתבש, לרוב החלק של ההוכחות בסוף, לכן העדפתי להגיש את החלק העיוני בפורמט markdown ואני מקווה שהדבר התקבל בהבנה
<br></br>

4. הוכחות, דוגמאות והגדרות מתמטיות השארתי באנגלית כי פשוט לא אפשרי לנהל תווים באנגלית ובעברית יחד באותה שורה בקובץ README מבלי שזה ייצא לא קריא לחלוטין
<br></br>

5. על מנת להריץ את התוכנית צריך לוודא הימצאות של הספריות הבאות, ובמידת הצורך להתקין אותם באופן הבא
...
<br></br>
מציין כי אלגנטי יותר להגדיר פעולה על ידי התנועה של הלוח הריק, במקום להסתכל על תנועת יתר האריחים,
אבל שמתי לב לאופציה הזו בשלב מאוחר מדי
...
הבחירה במבנה נתונים זה מובילה לכך שילדי הצמתים של הרמה הנוכחית נכנסים ראשונים לתור,
ולכן גם יצאו ממנו ויודפסו לפני הבנים שלהם הנמצאים ברמה הבאה (העמוקה יותר).
כפועל יוצא, אם בן של צומת ברמת עומק מסויימת מכיל את מצב המטרה,
הסריקה תעצר את החיפוש בו לא תמשיך לפתח בנים של צמתים ברמה הבאה.
<br></br>
...
ראוי לציון כי בהשוואה לפתרונות יוריסטיים, חיפוש לרוחב מפתח כמות עצומה של צמתים,
ולכן גם אינו כל כך יעיל אם לוקחים בחשבון סיבוכיות זמן.
